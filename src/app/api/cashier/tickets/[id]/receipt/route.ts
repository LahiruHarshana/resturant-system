...
import { getReceipt } from "@/server/cashier/receipt-service";
...
export async function GET(
  ...
  try {
    ...
    const receipt = await getReceipt(ticketId, session.user.id);
    ...
    console.error("GET /api/cashier/tickets/[id]/receipt error:", error);
    return NextResponse.json(
